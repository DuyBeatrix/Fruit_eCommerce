...
<head>
    ...
    <link href="<c:url value="/WEB-INF/resource/user/lib/lightbox/css/lightbox.min.css"/>" rel="stylesheet">
    <link href="<c:url value="/WEB-INF/resource/user/lib/owlcarousel/assets/owl.carousel.min.css"/>" rel="stylesheet">


    <!-- Customized Bootstrap Stylesheet -->
    <link href="<c:url value="/WEB-INF/resource/user/css/bootstrap.min.css"/>" rel="stylesheet">

    <!-- Template Stylesheet -->
    <link href="<c:url value="/WEB-INF/resource/user/css/style.css"/>" rel="stylesheet">


<%--    <link href="<c:url value="/resource/user/css/style"/>" rel="stylesheet">--%>
<%--    <c:url value="..."/>/img/categories/cat-1.jpg--%>
<%--    <c:url var="url" value="/resource/user"></c:url>--%>
