                        ...
                        <div class="col-md-6 col-lg-7 d-flex align-items-center">
                            <div class="card-body p-4 p-lg-5 text-black">
                                <form:form action="login" method="post" modelAttribute="user">
                                    ...
                                    <p><a class="small" href="${pageContext.request.contextPath}/forgotPassword" style="color: #7fad39;">Quên mật
                                        khẩu ?</a></p>
                                    <p class="mb-5 pb-lg-2">Bạn chưa có tài khoản ? <a href="<c:url value="/register"/>"
                                                                                       style="color: #7fad39;"> Đăng
                                        kí</a></p>
