                        ...
                        <div class="d-flex mb-2">
                            <c:choose>
                                <c:when test="${item.sale > 0}">
                                    <h5 class="fw-bold me-2">${item.sale} $</h5>
                ...
                <div class="row g-4 fruite">
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="d-flex align-items-center justify-content-start">
                            ...
                            <div>
                                <h6 class="mb-2"><a href="${pageContext.request.contextPath}/shop-detail/${item.productId}">${item.productName}</a></h6>
                                <div class="d-flex mb-2">
                                    <i class="fa fa-star text-secondary"></i>
                                    <i class="fa fa-star text-secondary"></i>
                                    <i class="fa fa-star text-secondary"></i>
            ...
            <div class="owl-carousel vegetable-carousel justify-content-center">
                ...
                <div class="border border-primary rounded position-relative vesitable-item">
                    <div class="vesitable-img">
                        <img src="<c:url value="/resource/user/img/products/${items.productImg}"/>" class="img-fluid w-100 rounded-top" alt="">
                    </div>
                    <div class="text-white bg-primary px-3 py-1 rounded position-absolute" style="top: 10px; right: 10px;">${items.cateName}</div>
                    <div class="p-4 pb-0 rounded-bottom">
                        <h4><a href="${pageContext.request.contextPath}/shop-detail/${items.productId}">${items.productName}</a></h4>
