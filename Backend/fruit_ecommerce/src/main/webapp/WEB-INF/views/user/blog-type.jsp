            ...
            <div class="container">
                <div class="row">
                            ...
                            <div class="blog__sidebar__item">
                                ...
                                <ul>
                                    ...
                                    <c:forEach var="categoryBlog" items="${blogTypes}">
                                        <%--                                        <li><a href='<c:url value="/blog/${categoryBlog.blogId}"/>'></a></li>--%>
                    ...
                    <div class="col-lg-8 col-md-7">
                        <div class="row">
                            <c:forEach var="itemBox" items="${blogDetailsType}">
                            ...
                            <div class="col-lg-12">
                                <div class="product__pagination blog__pagination">
                                    <c:forEach begin="1" end="${endPage}" var="index">
                                            ...
                                            <a href="${pageContext.request.contextPath}/blog-type/${idBlog}/${index}">${index}</a>
