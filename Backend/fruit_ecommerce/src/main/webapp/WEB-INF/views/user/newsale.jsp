                    ...
                    <c:forEach var="item" items="${product}">
                        <div class="border border-primary rounded position-relative vesitable-item">
                            <div class="vesitable-img">
                                <img src="<c:url value="/resource/user/img/${item.productImage}"/>" class="img-fluid w-100 rounded-top" alt="">
                            </div>
            ...
            <div class="vesitable">
                <div class="owl-carousel vegetable-carousel justify-content-center">
                    ...
                    <c:forEach var="item" items="${product}">
                        <div class="border border-primary rounded position-relative vesitable-item">
                            <div class="vesitable-img">
                                <img src="<c:url value="/resource/user/img/${item.productImage}"/>" class="img-fluid w-100 rounded-top bg-light" alt="">
                            </div>
                            <div class="text-white bg-primary px-3 py-1 rounded position-absolute" style="top: 10px; right: 10px;">${item.cateName}</div>
                            <div class="p-4 pb-0 rounded-bottom">
                                <h4>${item.productName}</h4>
                                ...
                                <div class="d-flex justify-content-between flex-lg-wrap">
                                    <div class="w-100 text-center">
                                        ...
                                        <p class="text-dark fs-5 fw-bold ml-2">${item.productPrice} VND/KG</p>
                                    </div>
                                </div>
                                <div class="w-100 text-center"><a href="${pageContext.request.contextPath}/addCart/${item.id}" class="btn border border-secondary rounded-pill px-3 py-1 mb-4 text-primary"><i class="fa fa-shopping-bag me-2 text-primary"></i> Add to cart</a></div>
                                <!-- CHUYEN RA GIUA -->
                            </div>
                        </div>
                    </c:forEach>
